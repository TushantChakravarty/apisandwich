...
const processTransactionTest =async  ()=>{
  ...
  const processPayinRequestBazorpay =async  (data)=>{
   ...
   const response = await fetch(`https://api.bazorpay.com/transactions/createtransaction?merchant_id=MR_0000013&api_key=CwZYdjcDNFlkY56P4H5SEvhCyhFE05KidHhYPW_yo9GzXSQ1&transaction_id=${txId}&amount=${data.amount}&user_name=${data.username}&mobile_no=${data.phone}&email=${data.emailId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Access-Control-Allow-Origin' : '*',
  ...
  const bazorPay =async (data)=>{
    ...
    const fetchPayintStatus = async (data)=>{
      const response = await fetch(`https://api.bazorpay.com/transactions/fetchtransactiondata?merchant_id=MR_0000013&api_key=CwZYdjcDNFlkY56P4H5SEvhCyhFE05KidHhYPW_yo9GzXSQ1&transaction_id=${data.transaction_id}&date=2023-09-19`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Access-Control-Allow-Origin' : '*',
