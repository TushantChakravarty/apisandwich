...
const processTransactionTest =async  ()=>{
  ...
  const processPayinRequestBazorpay =async  (data)=>{
   ...
   const response = await fetch(`https://api.bazorpay.com/transactions/createtransaction?merchant_id=MR_0000012&api_key=ohlDv5Sk6_uePsEWeZbT8HFu1Td-GDUJJCz0N2TDKXjQJS8M&transaction_id=${txId}&amount=${data.amount}&user_name=${data.username}&mobile_no=${data.phone}&email=${data.emailId}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Access-Control-Allow-Origin' : '*',
  ...
  const bazorPay =async (data)=>{
    ...
    const fetchBazorpayPaymentStatus = async (data)=>{
      const response = await fetch(`https://api.bazorpay.com/transactions/checkpayoutstatus?merchant_id=MR_0000012&api_key=ohlDv5Sk6_uePsEWeZbT8HFu1Td-GDUJJCz0N2TDKXjQJS8M&transaction_id=${data.transaction_id}&mobile_no=9717123456&email=example@gmail.com`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Access-Control-Allow-Origin' : '*',
