...
async function paythroughyPayinIntent (details){
 ...
 console.log(referenceId)
  const response = await fetch('https://upi.paythrough.in/payments/intent', {
      ...
      body: JSON.stringify({
          "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwibWNvZGUiOiJLVFBMIiwibmFtZSI6IkthcHdpc2UgVGVjaG5vbG9naWVzIFByaXZhdGUgTGltaXRlZCIsInR5cGUiOiJtZXJjaGFudCIsImlzcyI6InVybjpwYXl0aHJvdWdoIiwiZXhwIjoxNzA2NDQ4MjIyLCJpYXQiOjE3MDY0NDY0MjJ9.x1PUr1jI6w5hfjRwYsigodsvmy1af3Wd80OztquG_oI",
          "token_type": "bearer",
          "user": {
          "first_name": details.username,
          "last_name": "payhub",
