 ...
 console.log(referenceId)
  const response = await fetch('https://app.pinwallet.in/api/payout/dotransaction', {
      ...
      headers: {
        ...
        'Access-Control-Allow-Methods':'GET,PUT,POST,DELETE,PATCH,OPTIONS', 
        'AuthKey':'edb7293b7a983d8b330a52a2ef139b8ee8054ac832db536491d197fee0184667',
        'IPAddress':'54.254.162.138',
        Authentication: 'Bearer {eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI5OTkwMDA4NjYzIiwibmFtZWlkIjoiMTQ3IiwiZW1haWwiOiJpbmZvQHdlcm5lci5hc2lhIiwianRpIjoiODIxNWI1MGMtOGZlNy00NzBjLWJiZDYtYzZiNjdiY2M2N2Q1IiwiZXhwIjoxNjk4MzIxMjY2LCJpc3MiOiJFenVsaXhiMmIiLCJhdWQiOiJFenVsaXhiMmIifQ.XlvfKl4rmI1nZtqgqwMJv8mXqytyPk2BOrsJXsTZFnM}'
      },
      body: JSON.stringify({
