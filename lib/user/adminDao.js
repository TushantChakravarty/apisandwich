...
const getAllGatewaysSettlements = async (details) => {
  ...
  const paginated = gatewaySettlements.reverse().slice(details.skip, details.skip + details.limit);
...
const getGatewaySettlements = async (details) => {
  ...
  const paginated = filtered.reverse().slice(details.skip, details.skip + details.limit);
