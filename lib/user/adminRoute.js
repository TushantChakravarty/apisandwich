...
router.route('/updategatewaypayoutfee').post( (req, res) => {

   

    facade.updateGatewayPayoutFee(req.body).then((result) => {
...
router.route('/updategatewaycollectionfee').post( (req, res) => {

   

    facade.updateGatewayCollectionFee(req.body).then((result) => {
