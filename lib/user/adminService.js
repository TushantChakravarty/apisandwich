        ...
        return await validateRequest(details)
            .then(async (response) => {
                if (response == true) {
                    ...
                    const last24hrSuccess= Number(admin.last24hrSuccess) + 1
                    const last24hrTotal= Number(admin.last24hrTotal) + 1
        ...
        return await validateRequest(details)
            .then(async (response) => {
                if (response == true) {
                    ...
                    console.log("Total Transactions:", paginatedTransactions.length);
                ...
                return dao.getUserDetails(query).then(async (userData) => {
                    ...
                    if (Number(details.amount)) {
                        ...
                        if(gateway=='pinwallet')
                        {
                           ...
                           return pinwalletPayout(token.data.token)
                            .then((response)=>{
                                console.log(response)
                            })
                        }
