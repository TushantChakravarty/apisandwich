...
async function updateGatewayPayoutFee(details) {
    return validateRequest(details)
        .then((response) => {
            if (response == true) {
                ...
                return dao.updateGatewayPayoutFee(query, updateDetails).then((userUpdated) => {
                    if (userUpdated) {
                        console.log('success', userUpdated)
...
async function updateGatewayCollectionFee(details) {
    return validateRequest(details)
        .then((response) => {
            if (response == true) {
                const query =  details.gatewayName
                ...
                return dao.updateGatewayCollectionFee(query, updateDetails).then((userUpdated) => {
                    if (userUpdated) {
                        console.log('success', userUpdated)
