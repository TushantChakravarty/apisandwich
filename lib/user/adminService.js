    ...
    return await validateRequest(details)
        .then(async (response) => {
            ...
            if (response == true) {
                ...
                const adminProfit = user.platformFee>0?(Number(details.amount) / Number(user.platformFee)):0
                ...
                const updateDetails = {
                    ...
                    amountSettled:user.platformFee>0?Number(details.amount)-(Number(details.amount) / Number(user.platformFee)):Number(details.amount)
                }
                // let checkObj = {
                        ...
                        if (response) {
                            return dao.getUserBalance(query)
                                .then((response) => {
                                    ...
                                    const adminProfit = response.platformFee>0?(Number(details.amount) / Number(response.platformFee)):0
