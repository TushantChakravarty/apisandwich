                ...
                for (const user of response) {
                    ...
                    for (let i = 0; i < user.transactions.length; i++) {
                        ...
                        const body = {
                            ...
                            gateway: transaction.hash == 'xyzAirpay' ? 'airpay' : transaction.hash == 'xyzPaythrough' ? 'paythrough' : transaction.hash == 'xyzBazarpay' ? 'bazarpay' : transaction.hash == 'xyzSwipeline' ? "swipeline" : ''
                        }
