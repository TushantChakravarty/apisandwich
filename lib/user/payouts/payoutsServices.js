 ...
 .then((response)=>{
   if(response==true)
   {
       if(details?.status=="all"&&details?.start_date&&details?.end_date)
       {
        ...
        else if(details?.status=="success"||details?.status=="failed"||details?.status=="pending"&&details?.start_date=="all"&&details?.end_date=="all")
       {

         return dao.getPayoutsByStatus(details?.status)
         .then((userDetails)=>{
   ...
   if(response==true)
   {
      ...
      if(details?.status=="all"&&details?.start_date&&details?.end_date&&details?.email_Id)
        ...
        if(details?.status=="success"||details?.status=="failed"||details?.status=="pending"&&details?.start_date=="all"&&details?.end_date=="all"&&details?.email_Id)
       {
         ...
         return dao.getPayoutsByStatusMerchant(details?.email_Id,details?.status)
         .then((userDetails)=>{
