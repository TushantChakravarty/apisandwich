...
async function getAllTransactionsData() {

  const result = await transactionDao.find();

 //console.log(result[0].transactions[0])
const reversedTransactions = result[0].transactions.reverse();
