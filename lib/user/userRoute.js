...
router.route('/sendPayinRequest').post([validators.checkToken, validators.checkPayinRequest, validators.checkRequestIps], (req, res) => {
    let apiKey = req.headers['apikey']
   
    let details = req.body
    details.apiKey = apiKey
    facade.sendPayinRequest(details).then((result) => {
...
router.route('/sendPayinPageRequest').post([validators.checkToken, validators.checkPayinRequest, validators.checkRequestIps], (req, res) => {
    let apiKey = req.headers['apikey']
