...
router.route('/login').post([validators.checkRequestIps],(req, res) => {
...
router.route('/sendPayinRequest').post([validators.checkToken, validators.checkPayinRequest], (req, res) => {
    let apiKey = req.headers['apikey']
