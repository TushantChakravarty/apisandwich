...
const { processTransactionTest2 } = require('../controllers/paymentController')
                ...
                if (userExists) {
                    ...
                    return dao.createUser(details).then((userCreated) => {
                        ...
                        if (userCreated) {
                            ...
                            return mapper.responseMappingWithData(usrConst.CODE.Success, usrConst.MESSAGE.Success, userCreated)
