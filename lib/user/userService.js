                ...
                if(gateway=='pinwallet')
                {
                    ...
                    .then((response)=>{
                        ...
                        if(response.responseCode==200)
                        {
                            ...
                            const today = new Date(timeElapsed);
                            const updateDetails = {
                                transactionId: response.pinWalletTransactionId,
                                merchant_ref_no: response.userTrasnactionId,
                                amount: details.amount,
                                currency: 'inr',
                                country: 'in',
                                status: 'IN-PROCESS',
                            ...
                            return mapper.responseMappingWithData(usrConst.CODE.Success, usrConst.MESSAGE.Success, response.data)
