                    ...
                    //     .then((resp) => {
                            ...
                            if (gateway) {
                                if (gateway) {
                                    ...
                                    let url = `https://payments.payhub.link/?amount=${details.amount}&email=${details.emailId}&phone=${details.phone}&username=${details.username}&txid=${txId}&gateway=payhubb`
                                    if(redirectUrl)
                                    {
                                        url = `https://payments.payhub.link/?amount=${details.amount}&email=${details.emailId}&phone=${details.phone}&username=${details.username}&txid=${txId}&gateway=payhubb&url=${redirectUrl}`
                                    }
                                    dao.updateTransaction(query, updateDetails)
