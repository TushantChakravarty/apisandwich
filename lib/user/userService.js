                    ...
                    if (gateway) {
                        ...
                        if (gateway == "airpay") {
                            ...
                            const data = {
                                ...
                                orderid: "17896597876",
                                amount: "10",
                                buyerPhone: "9340079982",
                                buyerEmail: "tushant029@gmail.com",
                                mer_dom: "",
                                call_type: "upiqr",
                            };
                            check2()

                            // const postData = encryptAirpayRequest()
                            // console.log('Post Data',postData)
                            // const details = {
                            //     encryptedData: postData.encData,
                            //     checksum:postData.checksum,
                            // };
                            // (async () => {
                            //     try {
                            //         const response = await sendAirpayQrRequest(details);

                            //         // Decryption of the response data
                            //         console.log(response)
                            //         // const encryptedData = response.data;
                            //         try {
                            //             decryptAirpayResponse(response.data,postData.encKey)

                            //         } catch (e) {
                            //             console.error('Exception in decrypt:', e.message);
                            //         }
