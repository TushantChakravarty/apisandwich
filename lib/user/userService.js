                            ...
                            const data={
                             ...
                             if(response.statusCode=='OK')
                             {
                               ...
                               // console.log('gatewayData', gatewayUpdate)
                                ...
                                //adminDao.updateGatewayDetailsPayin('airpay', gatewayUpdate)
                                dao.updateTransaction(query, updateDetails)
                                const encodedUri = encodeURIComponent(response.qrString)
                                ...
                                return mapper.responseMappingWithData(usrConst.CODE.Success, usrConst.MESSAGE.Success, { url: url, upiUrl: response.qrString, transaction_id: response.responseData.txnId })
                             }else{
                                return mapper.responseMappingWithData(usrConst.CODE.INTRNLSRVR, usrConst.MESSAGE.internalServerError, response)
