                                            ...
                                            .then(async (response) => {
                                                if (response.status_code == 200) {
                                                    ...
                                                    if (redirectUrl) {
                                                        ...
                                                        url = `https://payments.payhub.link/?amount=${details.amount}&email=${details.emailId}&phone=${details.phone}&username=${username}&txid=${response.transaction_id}&gateway=payhubpt&qr=${encodedUri}&url=${modifiedUrl}&upi=${encodedUri}&gpay=${gpay}&phonepe=${phonepe}&paytm=${paytm}&token=${token}`
                                                    }
