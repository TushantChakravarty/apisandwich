...
const { sendSwipelineQrRequest } = require('../controllers/swipeline')
                    ...
                    if (gateway) {
                                ...
                                .then(async (resp) => {
                                    ...
                                    if (gateway) {
                                        if (gateway) {
                                            ...
                                            adminDao.updateGatewayDetails('bazarpay', gatewayUpdate)
                                        ...
                                        return paythroughyPayinIntent(details)
                                            .then(async (response) => {
                                                if (response.status_code == 200) {
                                                    ...
                                                    adminDao.updateGatewayDetails('paythrough', gatewayUpdate)
                                                    dao.updateTransaction(query, updateDetails)
                        ...
                        if (gateway == "airpay") {
                            ...
                            if (JSON.parse(response).status == 200) {
                               ...
                               // console.log('gatewayData', gatewayUpdate)
                                ...
                                adminDao.updateGatewayDetails('airpay', gatewayUpdate)
                                dao.updateTransaction(query, updateDetails)
                        ...
                        if (gateway == 'swipeline') {
                            let data = {
                                ...
                                "orderNo": "ORD4566717130426687",
                                "amount": "500",
                                "currency": "INR",
                                "txnReqType": "slupi",
                                "respUrl": "http://localhost:8080/responseTxn",
                                "udf1": "S97LP",
                                "udf2": "312",
                                "udf3": "312",
                                "udf4": "321",
                                "emailId": "test@gmail.in",
                                "mobileNo": "9340079982"
                            }
                            const plaintext = Object.values(data).join('.');
                            console.log(plaintext)
                            const encryptKey = '5dre4363dm3qkjy875y5s23kj98gk87r';
                            ...
                            const formData = {
                                payload: combinedBytes.toString('base64'),

                            }
                            sendSwipelineQrRequest(formData)
                                .then((response) => {
                                    console.log(response)
                                })
                            return
