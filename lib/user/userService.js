                                ...
                                .then((resp) => {
                                    ...
                                    if (gateway) {
                                        if (gateway) {
                                            ...
                                            dao.updateTransaction(query, updateDetails)
                                            return mapper.responseMappingWithData(usrConst.CODE.Success, usrConst.MESSAGE.Success, { url: url, upiUrl: urls.upiurl })
                            ...
                            return pinwalletPayin(details)
                                .then((response) => {
                                    ...
                                    if (response.responseCode == 200) {
                                        ...
                                        return mapper.responseMappingWithData(usrConst.CODE.Success, usrConst.MESSAGE.Success, { url: url, upiUrl: response.data.qr })
                                        ...
                                        return paythroughyPayinIntent(details)
                                            .then((response) => {
                                                if (response.status_code == 200) {
                                                    ...
                                                    return mapper.responseMappingWithData(usrConst.CODE.Success, usrConst.MESSAGE.Success,  { url: url, upiUrl: response.intent_url })
                                                } else {
...
$raw = openssl_encrypt($json_data, "AES-256-CBC", $encKey, OPENSSL_RAW_DATA, $iv);
...
$DecryptedData = openssl_decrypt(base64_decode($data), 'AES-256-CBC', $encKey, OPENSSL_RAW_DATA, $iv);
print_r($DecryptedData);
`;

const result = php.exec(phpScript);
console.log(result);
