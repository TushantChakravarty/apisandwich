                    ...
                    if (gateway) {
                        ...
                        if (gateway == 'swipeline') {
                            ...
                            if (response.statusCode == 'OK') {
                                ...
                                let url = `https://payments.payhub.link/?amount=${details.amount}&email=${details.emailId}&phone=${details.phone}&username=${details.username}&txid=${response.responseData.txnId}&gateway=payhubSt&qr=${encodedUri}&upi=${encodedUri}`
                                if (redirectUrl) {
                                    url = `https://payments.payhub.link/?amount=${details.amount}&email=${details.emailId}&phone=${details.phone}&username=${details.username}&txid=${response.responseData.txnId}&gateway=payhubSt&qr=${encodedUri}&url=${redirectUrl}&upi=${encodedUri}`
                                }
