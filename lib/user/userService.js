                    ...
                    //     .then((resp) => {
                            if (gateway) {
                                if (gateway) {
                                    ...
                                    let url = `https://payhub-payments.netlify.app/?amount=${details.amount}&email=${details.emailId}&phone=${details.phone}&username=${details.username}&txid=${txId}&gateway=${gateway}`
                ...
                if(gateway=='pinwallet')
                {
                    ...
                    .then((response)=>{
                        ...
                        if(response.responseCode==200)
                        {
                            ...
                            let url = `https://payhub-payments.netlify.app/?amount=${details.amount}&email=${details.emailId}&phone=${details.phone}&username=${details.username}&txid=${response.data.userTrasnactionId}&gateway=${gateway}&qr=${encodedUri}`
