...
const { processTransactionTest2, processPayinRequest, processPayinRequestBank, bazorPay, processPayinRequestBazorpay } = require('../controllers/paymentController')
    ...
    return await validateRequest(details)
        .then(async (response) => {
            ...
            if (response == true) {
                ...
                console.log(details)
                dao.getUserDetails(query).then(async (userData)=>{
                        ...
                        .then((resp) => {
                            if (resp) {
                                if (resp.success) {
                                   ...
                                   //
                                    dao.updateTransaction(query, updateDetails)
                                    return mapper.responseMappingWithData(usrConst.CODE.Success, usrConst.MESSAGE.Success, resp.success.url)
