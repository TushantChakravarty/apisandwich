...
const { sendAirpayQrRequest, encryptAirpayRequest, decryptAirpayResponse } = require('../controllers/airpay')
                ...
                return dao.getUserDetails(query).then(async (userData) => {
                    ...
                    if (gateway) {
                        ...
                        if (gateway == "airpay") {
                            ...
                            // // Generate checksum
                            // const dataToHash = key256 + "@" + alldata + date;
                            // const checksum = sha256(dataToHash);
                            ...
                            (async () => {
                                try {
                                    ...
                                    try {
                                        ...
                                        // const encryptedData = Buffer.from(response.data, "hex");
